...
import { HeartPulse, ArrowLeft, ShieldCheck, Sparkles, AlertCircle, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 text-left">
      ...
      <div className="w-full lg:w-[42%] bg-slate-950/60 backdrop-blur-md p-8 md:p-10 rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden">
        ...
        <span className="text-teal-400 font-extrabold text-xs tracking-[0.25em] uppercase block mb-3 relative z-10">
          BIENESTAR Y SALUD
        </span>
        ...
        <p className="text-slate-300 text-xs md:text-sm leading-relaxed mb-6 font-semibold relative z-10">
          Protege a tu familia o a los colaboradores de tu empresa con planes de salud premium. Acceso directo a los mejores especialistas y centros de salud del país.
        </p>
