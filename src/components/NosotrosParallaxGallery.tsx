...
const IMAGES = [
  { src: "/images/nosotros-cubo-1.png", top: "4%", left: "2%", size: "34%", rot: -6, depth: 0.35, z: 2 },
  { src: "/images/nosotros-cubo-2.png", top: "0%", left: "40%", size: "40%", rot: 4, depth: 0.55, z: 4 },
  { src: "/images/nosotros-cubo-3.png", top: "10%", left: "74%", size: "26%", rot: -4, depth: 0.25, z: 1 },
  { src: "/images/nosotros-cubo-4.png", top: "48%", left: "6%", size: "36%", rot: 5, depth: 0.45, z: 3 },
  { src: "/images/nosotros-cubo-5.png", top: "50%", left: "52%", size: "42%", rot: -3, depth: 0.6, z: 5 },
  { src: "/images/nosotros-cubo-6.png", top: "70%", left: "24%", size: "28%", rot: 7, depth: 0.3, z: 2 },
] as const;
